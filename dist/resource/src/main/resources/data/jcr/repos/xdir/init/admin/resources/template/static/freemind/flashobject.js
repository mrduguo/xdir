...
if(Array.prototype.push == null){
	Array.prototype.push = function(item) { this[this.length] = item; return this.length; }
		...
		document.write("<div id=\"flashcontent\" style=\"width:100%;height:100%;\"></div>");
		document.getElementById("flashcontent").style.height=(document.documentElement.clientHeight)+"px";
		var fo = new FlashObject("visorFreemind.swf", "visorFreeMind", "100%", "100%", 0, "#9999ff");
		fo.addParam("quality", "high");
		fo.addParam("bgcolor", "#ffffff");
		fo.addVariable("openUrl", "_self");
		fo.addVariable("initLoadFile", window.location.href.substring(window.location.href.indexOf("mm=")+3));
		//fo.addVariable("initLoadFile", "freemind/map.mm");
